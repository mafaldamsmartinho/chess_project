...
# before queries; you control flushing more explicitly.
# expire_on_commit=False → after commit(), your object's attributes remain
# accessible without SQLAlchemy automatically reloading them from the database.
